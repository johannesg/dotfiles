...
let g:unite_source_rec_async_command = ['ag', '--follow', '--nocolor', '--nogroup', '--hidden', '-p', '''~/.agignore''', '-g', '']
let g:unite_source_history_yank_enable = 1
"
" Use ag in unite grep source.
let g:unite_source_grep_max_candidates = 200
let g:unite_source_grep_command = 'ag'
let g:unite_source_grep_default_opts = '-i --vimgrep --hidden --ignore ''.hg'' --ignore ''.svn'' --ignore ''.git'' --ignore ''.bzr'' -p ''~/.agignore'''
